...
- And learning PHP, Laravel, MySQL, Unit & Integration testing (including TDD & DDD methods), MVC, SOLID & design patterns (KISS, DRY etc.) GIT, Building REST API and JavaScript, TypeScrypt, HTML & CSS, Angular basics
